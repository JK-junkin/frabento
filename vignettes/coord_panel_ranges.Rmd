...
ips <- installed.packages()[, 1]
if(!("emo" %in% ips)) devtools::install_github("hadley/emo")
if(!("fontregisterer" %in% ips)) devtools::install_github("Gedevan-Aleksizde/fontregisterer", upgrade = "never")
```
...
## 使用例
```{r setup, echo = 2:4, eval = -c(1), message = FALSE}
